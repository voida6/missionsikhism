...
order: 35
summary: "The Harmandir Sahib is a building with an argument in it — four doors, a lower floor than the ground around it, and gold added by a Maharaja three centuries after it was founded."
tags:
  - heritage
sources:
  ...
  - title: "The Encyclopaedia of Sikhism"
    ...
    page: "Entries: Harimandar; Gurdwara; Sikh architecture"
...
## A building that argues

The Harmandir Sahib at [Amritsar](/places/amritsar) is the most photographed Sikh structure in the world, and almost every feature people notice about it is making a point.

It has **four doors**, one on each side. The conventional reading is that it opens to people coming from any direction and of any background — the same claim the [langar](/glossary/langar) makes with food.

It sits **lower than the ground around it**. You go *down* steps to reach it, where a temple would normally be raised above its approach. A visitor arrives by descending.
