---
title: "Ceremonies & Rites of Passage"
order: 5
summary: "The ceremonies that mark a Sikh life — naming, initiation, marriage and death — all centred on the Guru Granth Sahib."
sources:
  - title: "Sikh Rehat Maryada — the Sikh Code of Conduct"
    author: "Shiromani Gurdwara Parbandhak Committee"
    note: "approved by the SGPC, 1945 (primary source)"
...
**Amrit Sanchar** — also called *Khande di Pahul* — is initiation into the Khalsa, the discipline established in 1699. Five initiated Sikhs, the **Panj Pyare**, prepare *amrit* (sweetened water) in an iron bowl, stirred with a double-edged *khanda* while the sacred hymns are recited.
