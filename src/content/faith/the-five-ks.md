...
title: "The Five Ks"
order: 25
summary: "The five articles an initiated Sikh wears at all times — uncut hair, comb, steel bracelet, undergarment and sword. They are the most visible thing about Sikh identity and the least casually understood."
tags:
  - identity
  - practice
sources:
  - title: "Sikh Rehat Maryada — the Sikh Code of Conduct"
    ...
    year: 1945
    note: "the authority for what the Five Ks are and who is required to wear them (primary source)"
  ...
  - title: "The Encyclopaedia of Sikhism"
    ...
    page: "Entry: Panj Kakar"
  - title: "When Sparrows Became Hawks: The Making of the Sikh Warrior Tradition, 1699–1799"
    author: "Purnima Dhavan"
    publisher: "Oxford University Press"
    year: 2011
    note: "on how the Khalsa's outward markers were consolidated across the eighteenth century"
---

## The five

Every Sikh initiated into the [Khalsa](/glossary/khalsa) undertakes to keep five articles on the body at all times. In Punjabi they each begin with the letter *kakka*, hence *panj kakaar* — the five Ks.

- **Kes** — uncut hair, kept covered, in practice by the turban for men and by many women.
- **Kangha** — a small wooden comb, worn in the hair. Order, and the discipline of tending what you keep.
- **Kara** — a steel bracelet on the wrist, worn where the hand can see it.
