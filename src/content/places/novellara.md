...
summary: "A small town in the Po valley with one of Italy's largest Sikh communities, working the dairy farms that produce Parmigiano-Reggiano. Its purpose-built gurdwara, opened in 2000, was the first in Italy."
sources:
  - title: "Sikh immigrants in Northern Italy. A case-study: Novellara (RE), Italy"
    author: "Emma Rossi"
    publisher: "Global Research Forum on Diaspora and Transnationalism"
    url: "https://grfdtonline.com/Upload/JournalGallery/1_371044557_Emma%20Rossi.pdf"
    note: "an academic case study of this specific community"
  - title: "Sikhism in Italy"
    publisher: "Wikipedia"
    url: "https://en.wikipedia.org/wiki/Sikhism_in_Italy"
    note: "used only for the count of gurdwaras and the broad distribution; the population figures here come from the sources above and below"
  - title: "Sikhism by country"
